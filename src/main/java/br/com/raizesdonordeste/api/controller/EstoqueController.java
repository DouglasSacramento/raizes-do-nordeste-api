...
public class EstoqueController {
    ...
    public ResponseEntity<EstoqueResponseDTO> abastecerEstoque(@Valid @RequestBody EstoqueRequestDTO dados) {
        ItemEstoque estoqueNovo = estoqueService.abastecerEstoque(dados);
